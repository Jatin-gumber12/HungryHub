...
public final class MenuItemBinding implements ViewBinding {
  ...
  private MenuItemBinding(@NonNull LinearLayout rootView, @NonNull TextView MenuAddToCart,
  ...
  public static MenuItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new MenuItemBinding((LinearLayout) rootView, MenuAddToCart, MenuFoodName, MenuImage,
          MenuPrice);
    }
